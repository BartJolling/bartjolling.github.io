...
The example code that accompagnies this article can be found in [my TimeZoneConverter repository on Github](https://github.com/BartJolling/TimeZoneConverter). It hosts a version using .NET 4.8 and a version using .NET 6.0 with the [CoreWCF libraries](https://github.com/CoreWCF/CoreWCF).
